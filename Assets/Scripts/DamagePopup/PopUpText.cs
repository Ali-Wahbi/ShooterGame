...
public class PopUpText : MonoBehaviour
{
    ...
    Color originalColor;
    public void Setup(int textDamage, PopupColor color)
    {
    ...
    public static void Create(int damage, Vector3 pos, PopupColor color = PopupColor.Original)
    {
        ...
        popText.Setup(textDamage: damage, color);
    }
